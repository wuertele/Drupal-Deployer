  ...
  <xsl:template match="/">
    <html>
      ...
      <body onLoad="initXsl('table0','{$fileType}');">
        ...
        <br/>
        <p id="copyright">
          Generated by the <a href="http://drupal.org/project/xmlsitemap">Drupal XML sitemap module</a> [version].<br />
          <!-- Copyright &#169; 2005 <a href="http://www.baccoubonneville.com">Baccou Bonneville</a>. Licensced under the GNU/LGPL. -->
        </p>
      </body>
    </html>
  </xsl:template>
